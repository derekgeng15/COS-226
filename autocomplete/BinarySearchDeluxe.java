...
public class BinarySearchDeluxe {
    ...
    public static void main(String[] args) {
        Term[] a = { new Term("a", 1), new Term("a", 2), new Term("b", 1), new Term("b", 2), new Term("b", 3),
                new Term("c", 1), new Term("d", 1), new Term("d", 2), new Term("f", 1) };
        ...
        for (Term t : a)
            StdOut.println(t + " ");
        StdOut.println("Key: " + key);
        StdOut.println("First Index Of: " + firstIndexOf(a, key, Term.byReverseWeightOrder()));
        StdOut.println("Last Index Of: " + lastIndexOf(a, key, Term.byReverseWeightOrder()));
    }
}
